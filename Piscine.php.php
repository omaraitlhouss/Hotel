<?php 
 include "admin/includes/conx.php";
  $prepare=$pdo->query("select * from services where Nom_ser='Piscine'");
...
<html lang="en">
  <head>
    ...
    <title>OREN - Service Piscine</title>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/pici.jpg" alt="" class="img-fluid shadow" style="">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/pici1.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/pici2.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>

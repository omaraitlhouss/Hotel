<?php 
 include "admin/includes/conx.php";
  $prepare=$pdo->query("select * from services where Nom_ser='Restaurant'");
...
<html lang="en">
  <head>
    ...
    <title>OREN - Service Restaurant</title>
...
<!--Header-->
	...
	<!-- BANNER -->
	<div class="section banner-page" data-background="images/rest3.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Restaurant</div>
			</div>
		</div>
	</div>
	...
	<!-- PORTFOLIO -->
	<div class="section" style="margin-bottom: -135px;">
		<div class="content-wrap">
			<div class="container">						

				<div class="row">
					<div class="col-sm-8 col-md-8" style="padding-left: 90px;
    margin-top: 40px;">
						<img src="images/rest1.jpg" alt="" class="img-fluid shadow" style="">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/rest.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/rest2.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							<h3 class="text-primary">DÉTAILS SUR LE SERVICE</h3>

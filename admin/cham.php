<?php 
    ...
    $prepare=$pdo->query("select Tele from chambre where Id_cham='".$id_cham."'");
                                  ...
                                  <div class="row">
                                    <div class="col-sm-6">
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="telephone_chambre" value="<?php echo $chambre->Tele ?>"  class="form-control" />
                                      </div>
                                    </div><!-- col-sm-6 -->
                                    <div class="col-sm-6">
                                      <div class="form-group">
                                        <label class="control-label">Etage Chambre</label>
                                        <input type="text" name="etage_chambre" value="<?php echo $chambre->Etage; ?>" class="form-control" />
                                      </div>
                                    </div>
                                  </div><!-- row -->
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="tarif" value="<?php echo $chambre->Tarif_cham; ?>" class="form-control" />
                                      </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="photo" value="<?php echo $chambre->photo; ?>" class="form-control" />
                                      </div>
                                    </div>
                                    <div class="col-sm-6">
                                      <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="Nbr-Lits" value="<?php echo $chambre->Nbr_lits; ?>" class="form-control" />
                                      </div>
                                    </div>
                                    <div class="col-sm-6">
                                      <div class="form-group">
                                        <label class="control-label">Id_cham</label>
                                        <input type="label" name="Id_cham" class="form-control" value="<?php echo $chambre->Id_cham; ?>" >

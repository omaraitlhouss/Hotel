...
<html lang="en">
  <head>
    ...
    <title>OREN - HOTEL Heiligendamm</title>
...
<body>
	...
	<!-- BANNER -->
	<div class="section banner-page" data-background="images/cov22.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Heiligendamm</div>
			</div>
		</div>
	</div>
<!--Formulaire Reserver-->
	...
	<div class="form-group">
	      ...
	      <select id="inputState" class="form-control" name="ville" style="width: 26%;"> 
	        <option selected>Heiligendamm</option>
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL Grand Hotel Heiligendamm</option>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/h2.jpg" alt="" class="img-fluid shadow" style="margin-top: 30px;">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/h3.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/h1.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Situé à Heiligendamm, sur la côte de la mer Baltique, l'établissement de luxe Grand Hotel Heiligendamm dispose de plusieurs restaurants et bars, d'installations de spa et de chambres élégantes avec vue sur la mer ou le parc.

Il propose des chambres spacieuses et élégantes réparties dans 4 bâtiments de style classique. Les chambres sont ornées d'un mobilier conçu sur mesure et vous y bénéficierez gratuitement d'une connexion Internet et d'une bouteille d'eau.

Un petit-déjeuner américain est servi tous les matins. Les options de restauration comprennent le restaurant Friedrich Franz, étoilé au guide Michelin, le bar à sushis Baltic et le restaurant historique Kurhaus.

Le spa Heiligendamm de 3 000 m² comprend une piscine, un programme de sport varié et un bar. Vous y trouverez également un club animé pour enfants et une aire de jeux.

Si vous êtes amateurs de sport, vous pourrez faire une partie de golf, vous balader à travers la campagne ou faire une variété d'activités nautiques à Heiligendamm et dans la région environnante.
...
Cet établissement a également été bien noté pour son excellent rapport qualité/prix à Heiligendamm ! Les clients en ont plus pour leur argent en comparaison avec d'autres établissements dans cette ville.</p>
						</div>
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Animaux domestiques admis </br> Spa et centre de bien-être </br> Piscine </br> Parking </br> Piscine intérieure </br> Connexion Wi-Fi gratuite </br> Bar </br> Front de mer</p>
						</div>

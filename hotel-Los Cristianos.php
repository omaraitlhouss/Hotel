...
<html lang="en">
  <head>
    ...
    <title>OREN - HOTEL LOS CRISTIANOS</title>
...
<!--Header-->
	...
	<!-- BANNER -->
	<div class="section banner-page" data-background="images/cov3.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Los Cristianos</div>
			</div>
		</div>
	</div>
<!--Formulaire Reserver-->
	...
	<div class="form-group">
	      ...
	      <select id="inputState" class="form-control" name="ville" style="width: 26%;"> 
	        <option selected>LOS CRISTIANOS</option>
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL LOS CRISTIANOS SOL ARONA</option>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/lc2.jpg" alt="" class="img-fluid shadow" style="">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/lc.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/lc6.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Le Sol Arona Tenerife se trouve à 200 mètres de la plage de Los Cristianos, à Tenerife. Il possède une grande piscine extérieure avec des chaises longues, ainsi que des chambres dotées d'un balcon offrant une vue sur la mer, pour la plupart.

Les enfants bénéficieront de leur propre piscine et des activités leur seront proposées sur l'aire de jeux de l'établissement, telles que l'escalade et le trampoline à élastiques. Pendant ce temps, vous aurez la possibilité de vous rendre à la salle de sport ou de prendre le soleil sur la terrasse bien exposée.

En fin de journée, toute la famille se retrouvera autour d'un dîner au restaurant-buffet, avant de profiter des divertissements nocturnes.

Vous rejoindrez l'aéroport de Ténérife Sud en moins de 20 minutes de route du Sol Arona Tenerife.
...
Les couples apprécient particulièrement l'emplacement de cet établissement. Ils lui donnent la note de 8,4 pour un séjour à deux.</p>
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Piscine </br> Connexion Wi-Fi gratuite </br> Parking gratuit </br> Chambres familiales </br> Salle de sport bien </br> Restaurant </br> Bar</p>
						</div>

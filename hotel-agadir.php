	...
	<div class="section banner-page" data-background="images/cov16.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Agadir</div>
			</div>
		</div>
	</div>
	<!--Formulaire Reserver-->
	...
	<div class="form-group">
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL ATLANTIC AGADIR</option>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/chambre-atlantic_402055_pgbighd.jpg" alt="" class="img-fluid shadow" style="margin-top: 50px;">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/piscine-atlantic_402061_pgbighd.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/reception-atlantic_401288_pgbighd.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						<div class="col-sm-12 col-md-8">
							...
							<p>Réservez l'hôtel Atlantic, à seulement 800 m de la plage d'Agadir et à 27 km de l'aéroport. Un petit hôtel de charme entièrement rénové, chaleureux, situé au cœur du secteur animé et commerçant de la ville. Vous apprécierez son ambiance conviviale et son personnel attentionné. Logement L'hôtel Atlantic 4* vous accueille dans une petite structure de 2 étages au style mauresque.
Il dispose de 44 chambres (20 m²) : TV, climatisation, coffre-fort, salle de bains avec douche ou baignoire. Wi-Fi.
Chambres communicantes sur demande. Bon à savoir Les chiens (- 5 kg) sont acceptés sauf dans les parties communes.
L'hôtel ne possède pas de chambre triple adulte.
2 étages sans ascenseur. .</p>
						</div>
						<div class="col-sm-12 col-md-4">
							<p class="uk18 text-black mb-1"><strong>Date d'ouverture :</strong></p>
							<p>18th Janvier, 2019</p>
							<p class="uk18 text-black mb-1"><strong>Etoils :</strong></p>
							<p>3</p>
										
						</div>
						<div class="col-sm-12 col-md-8">
							<h3 class="text-primary">Restauration</h3>
							<p>Formule demi-pension :
Petit déjeuner continental et traditionnel au buffet.
Service à table avec menus ou buffet pour le dîner.

En option pension complète avec supplément : 
Déjeuner servi à table avec menus. 

Avec supplément : boissons, snack-grill au bord de la piscine, restaurant marocain à la carte. </p>
						</div>

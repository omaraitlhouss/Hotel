	...
	<div class="section banner-page" data-background="images/cov14.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Alge</div>
			</div>
		</div>
	</div>
<!--Formulaire Reserver-->
	...
	<div class="form-group">
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL Suisse Algé</option>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/oran7.jpg" alt="" class="img-fluid shadow" style="margin-top: 20px;">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/oran6.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/oran5.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Situé à Alger, l'hôtel 3 étoiles Suisse propose des hébergements climatisés, une réception ouverte 24h/24 et un restaurant.

Les chambres disposent d'un bureau, d'une salle de bains privative pourvue d'une baignoire ou d'une douche et d'articles de toilette gratuits, ainsi que d'une télévision par satellite à écran plat.

Un petit-déjeuner continental est servi chaque jour.

L'aéroport d'Alger-Houari Boumédiène, le plus proche, est installé à 23 km.

Cet établissement a également été bien noté pour son excellent emplacement à Alger ! Les clients en sont plus satisfaits en comparaison avec d'autres établissements dans cette ville.

Cet établissement a également été bien noté pour son excellent rapport qualité/prix à Alger ! Les clients en ont plus pour leur argent en comparaison avec d'autres établissements dans cette ville.</p>
						</div>
						<div class="col-sm-12 col-md-4">
							<p class="uk18 text-black mb-1"><strong>Date d'ouverture :</strong></p>
							<p>16th Decembre, 2018</p>
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Connexion Wi-Fi gratuite </br> Restaurant </br> Chambres non-fumeurs </br> Réception ouverte 24h/24 </br> Bar</p>
						</div>

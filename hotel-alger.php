	...
	<div class="section banner-page" data-background="images/cov22.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Alger</div>
			</div>
		</div>
	</div>
<!--Formulaire Reserver-->
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/alger2.jpg" alt="" class="img-fluid shadow" style="">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/alger1.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/mz.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Situé à Alger, l'Oasis Hotel propose un bar, un restaurant ainsi qu'une réception ouverte 24h/24.

Offrant une vue sur la mer, les chambres comprennent un coin salon, une salle de bains privative, un bureau et une télévision.

Un petit-déjeuner continental est servi dans la salle à manger.

Vous bénéficierez d'une connexion Wi-Fi gratuite et d'un parking privé sur place. L'aéroport d'Alger-Houari Boumédiène, le plus proche, est situé à 13 km de l'Oasis Hotel.</p>
						</div>
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Connexion Wi-Fi gratuite </br>  Navette aéroport (gratuite) </br> Parking gratuit </br> Centre de remise en forme </br> Piscine </br> Spa et centre de bien-être </br> Bar</p>
						</div>

...
<html lang="en">
  <head>
    ...
    <title>OREN - HOTEL BARCELONE</title>
	...
	<div class="section banner-page" data-background="images/cov5.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Barcelone</div>
			</div>
		</div>
	</div>
<!--Formulaire Reserver-->
	...
	<div class="form-group">
	      ...
	      <select id="inputState" class="form-control" name="ville" style="width: 26%;"> 
	        <option selected>BARCELONE</option>
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL BARCELONE</option>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/barc2.jpg" alt="" class="img-fluid shadow" style="">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/barc1.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/barc3.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Le Catalonia Park Güell propose une connexion Wi-Fi gratuite et une piscine sur le toit. Cet hôtel est situé dans un quartier résidentiel en périphérie du centre historique de Barcelone, à 600 mètres du parc Güell.

Sobres et confortables, les chambres de l'hôtel comprennent la climatisation et une télévision par satellite. Sur place, vous disposerez d'un restaurant et d'un bar.

Vous séjournerez à seulement 300 mètres de la station de métro Vallcarca, qui dessert le centre-ville en moins de 10 minutes. Les arrêts des bus V19 et 22 sont à proximité. La terrasse bien exposée offre une vue sur la ville.

L'hôtel se situe à proximité de certains des plus célèbres centres médicaux de Barcelone, notamment des hôpitaux Delfos et Quirónsalud.

De nombreux clubs sportifs et parcs vous attendent à quelques pas de l'hôtel. Enfin, à quelques minutes de marche du Catalonia Park Güell, vous rejoindrez le quartier prisé de Gràcia, où vous trouverez des places animées bordées de bars et de restaurants.

Ce quartier (Gràcia) est un choix idéal pour les voyageurs qui s'intéressent à ces thèmes : les monuments, les balades en ville et l'architecture.</p>
						</div>
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Parking </br> Connexion Wi-Fi gratuite </br> Piscine </br> Chambres familiales </br> Animaux domestiques admis </br> Chambres non-fumeurs </br> Bar</p>
						</div>

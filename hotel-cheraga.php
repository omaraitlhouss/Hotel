...
<html lang="en">
  <head>
    ...
    <title>OREN - HOTEL CHERAGA</title>
	...
	<div class="section banner-page" data-background="images/cov8.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Cheraga</div>
			</div>
		</div>
	</div>
<!--Formulaire Reserver-->
	...
	<div class="form-group">
	      ...
	      <select id="inputState" class="form-control" name="ville" style="width: 26%;"> 
	        <option selected>CHERAGA</option>
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL Hôtel Madaure Cheraga</option>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/chambre40.jpg" alt="" class="img-fluid shadow" style="">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/ch2.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/ch3.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Installé à Chéraga, l'Hôtel Madaure vous propose une connexion Wi-Fi gratuite, une réception ouverte 24h/24, un restaurant et une terrasse bien exposée.

Les chambres de l'hôtel comprennent une télévision à écran plat, la climatisation ainsi qu'une salle de bains privative. Certaines bénéficient également d'un balcon.

Un petit-déjeuner continental vous sera servi tous les matins sur place.

L'aéroport international d'Alger-Houari-Boumédiène se trouve à 29 km de l'Hôtel Madaure.</p>
						</div>
						<div class="col-sm-12 col-md-4">
							<p class="uk18 text-black mb-1"><strong>Date d'ouverture :</strong></p>
							<p>09th Fevrier, 2018</p>

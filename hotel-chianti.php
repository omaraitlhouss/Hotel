...
<html lang="en">
  <head>
    ...
    <title>OREN - HOTEL Gaiole in Chianti</title>
	...
	<div class="section banner-page" data-background="images/cov10.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Chianti</div>
			</div>
		</div>
	</div>
<!--Formulaire Reserver-->
	...
	<div class="form-group">
	      ...
	      <select id="inputState" class="form-control" name="ville" style="width: 26%;"> 
	        <option selected>Gaiole in Chianti</option>
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL Castello di Spaltenna Exclusive Resort & Spa</option>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/chi1.jpg" alt="" class="img-fluid shadow" style="margin-top: 60px;">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/chi2.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/chi3.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Situé dans la campagne toscane, le Castello di Spaltenna Exclusive Resort & Spa est aménagé dans un ancien monastère du Xe siècle. Il dispose de deux piscines, dont une est chauffée, d'un restaurant et de chambres spacieuses pourvue d'une télévision avec les chaînes du bouquet Sky.

Les chambres du Castello Di Spaltenna présentent une décoration toscane traditionnelle et offrent une vue panoramique sur la vallée ou la cour. Toutes sont équipées d'une connexion Wi-Fi gratuite.

La piscine extérieure est agrémentée d'une cascade et d'une terrasse bien exposée pour profiter du soleil. En hiver, la piscine intérieure donne sur la campagne.

Le restaurant Il Pievano est situé dans le hall historique du château et propose une grande carte des vins comprenant de nombreux vins de la région du Chianti. Des dîners aux chandelles sont servis dans la cour.

L'établissement met également à votre disposition un sauna, un bain turc, une salle de sport, un court de tennis et une salle de billards. Le personnel pourra vous conseiller sur les nombreux sentiers de randonnée et pistes de VTT de la région.
...
Les couples apprécient particulièrement l'emplacement de cet établissement. Ils lui donnent la note de 9,3 pour un séjour à deux.</p>
						...
						<div class="col-sm-12 col-md-8">
							...
							<p> Parking gratuit </br> Piscine </br> Connexion Wi-Fi gratuite </br> Restaurant </br> Bar</p>
						</div>

...
<html lang="en">
  <head>
    ...
    <title>OREN - HOTEL CONSTANTINE</title>
	...
	<div class="section banner-page" data-background="images/cov12.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Constantine</div>
			</div>
		</div>
	</div>
<!--Formulaire Reserver-->
	...
	<div class="form-group">
	      ...
	      <select id="inputState" class="form-control" name="ville" style="width: 26%;"> 
	        <option selected>CONSTANTINE</option>
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL Constantine Marriott Hotel</option>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/con3.jpg" alt="" class="img-fluid shadow" style="">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/con2.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/con1.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Le Constantine Marriott Hotel propose des hébergements à Constantine et une connexion Wi-Fi gratuite dans l'ensemble de l'établissement. Il comporte un bar et un restaurant.

Certaines chambres possèdent un coin salon, pour votre confort. Elles sont équipées d'une télévision à écran plat, d'une machine à café, d'un sèche-cheveux et d'articles de toilette gratuits.

Vous trouverez également un salon de coiffure sur place.

L'aéroport international de Constantine-Mohamed Boudiaf, le plus proche du Constantine Marriott Hotel, se situe à 6 km.
...
Cet établissement a également été bien noté pour son excellent rapport qualité/prix à Constantine ! Les clients en ont plus pour leur argent en comparaison avec d'autres établissements dans cette ville.

</p>
						</div>
						<div class="col-sm-12 col-md-4">
							<p class="uk18 text-black mb-1"><strong>Date d'ouverture :</strong></p>
							<p>22th October, 2018</p>

...
<html lang="en">
  <head>
    ...
    <title>OREN - HOTEL Contrada Giubiliana</title>
	...
	<div class="section banner-page" data-background="images/cov4.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Contrada</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
	  ...
	  <div class="form-group">
	      ...
	      <select id="inputState" class="form-control" name="ville">
	        <option selected> Contrada Giubiliana</option>
	      </select>
	  </div>
...
Les couples apprécient particulièrement l'emplacement de cet établissement. Ils lui donnent la note de 9,0 pour un séjour à deux.</p>
						</div>

	...
	<div class="section banner-page" data-background="images/cov10.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Fes</div>
			</div>
		</div>
	</div>
<!--Formulaire Reserver-->
	...
	<div class="form-group">
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL NOUZHA FES</option>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/chambre-atlantic_401289_pgbighd.jpg" alt="" class="img-fluid shadow" style="margin-top: 50px;">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/promo-hotel-ifrane-maroc0.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/hotel-nouzha-fes_1.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Hmizate vous offre l’opportunité de séjourner  à petit budget au cœur de la ville de Fès, à l’hôtel Nouzha 3*, 1 nuit pour 2 adultes + 1 enfant (-5 ans) en chambre double avec petit déjeuner

 

Situé en plein centre ville, l’hôtel Nouzha, hôtel de charme 3 étoiles, à la fois moderne et de style traditionnel, rappelle nos demeures fassies par le luxe et le raffinement de ses fresques mauresques

 

Hôtel Nouzha dispose de 60 chambres avec suites et chambres doubles. Le téléphone, la climatisation et le chauffage, avec télévision satellitaire qui vous permet de visionner des chaînes internationales, sont présents dans toutes les chambres.

 

A  Fès, l'établissement Hôtel Nouzha se trouve tout près de Cimetière juif, Palais royal et Parc Jnane Sbile. Les sites Musée de Der Batha et Blue Gate se trouvent également à proximité. 

 

Découvrez Fès, ses souks et ses nombreux foundouks. Visitez les remparts de cette ancienne cité impériale, qui est aussi capitale gastronomique du Maroc.

 

 

Hôtel Nouzha est le lieu idéal pour séjourner dans cette ville magnifique !</p>
						</div>

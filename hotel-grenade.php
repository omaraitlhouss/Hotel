...
<html lang="en">
  <head>
    ...
    <title>OREN - HOTEL GRENADE</title>
	...
	<div class="section banner-page" data-background="images/cov1.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Grenade</div>
			</div>
		</div>
	</div>
<!--Formulaire Reserver-->
	...
	<div class="container">
		...
		<div class="form-group">
	        ...
	        <option selected>Grenade</option>
	...
	<div class="form-group">
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL GRENADE</option>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/lc4.jpg" alt="" class="img-fluid shadow" style="">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/gre2.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/mad1.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>L'Hotel Granada Center est situé à seulement 10 minutes à pied de la vieille ville de Grenade et à 5 minutes de la gare. Lors de votre séjour, vous profiterez d'une connexion Wi-Fi gratuite et d'un espace de stationnement privé payant.

Toutes les chambres du Granada Center disposent de la climatisation et d'une salle de bains privative. Elles comportent également une télévision et un minibar.

Le restaurant à la carte de l'Hotel Granada Center, l'Al Zagal, sert une cuisine méditerranéenne. Vous pourrez également prendre un verre au café-bar ou au pub anglais de l'hôtel. Des plats sans gluten sont proposés.

L'hôtel se trouve à seulement 10 minutes à pied de la cathédrale et de l'université de Grenade. L'arrêt de bus situé en face du Granada Center vous permettra d'accéder aux principaux sites d'intérêt de la ville.

Ce quartier (Centre de Grenade) est un choix idéal pour les voyageurs qui s'intéressent à ces thèmes : les monuments anciens, l'architecture et les monuments.

Les couples apprécient particulièrement l'emplacement de cet établissement. Ils lui donnent la note de 8,4 pour un séjour à deux.</p>
						</div>
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Parking </br> Connexion Wi-Fi gratuite </br> Chambres familiales </br> Chambres non-fumeurs </br> Centre de remise en forme </br> Restaurant </br> Bar</p>
						</div>

...
<html lang="en">
  <head>
    ...
    <title>OREN - HOTEL HOMBURG</title>
	...
	<div class="section banner-page" data-background="images/cov14.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Homburg</div>
			</div>
		</div>
	</div>
<!--Formulaire Reserver-->
	...
	<div class="form-group">
	      ...
	      <select id="inputState" class="form-control" name="ville" style="width: 26%;"> 
	        <option selected>HOMBURG</option>
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL Steigenberger Hotel Bad Homburg</option>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/con4.jpg" alt="" class="img-fluid shadow" style="">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/hom1.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/hom2.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>This hotel opposite Bad Homburg's Kurpark spa gardens offers an elegant Art Déco design and spacious, soundproofed rooms. It provides fine dining and a conservatory café.
...
The Steigenberger Bad Homburg's underground garage is available for an extra fee.

Cet établissement a également été bien noté pour son excellent emplacement à Bad Homburg vor der Höhe ! Les clients en sont plus satisfaits en comparaison avec d'autres établissements dans cette ville.
...
Cet établissement a également été bien noté pour son excellent rapport qualité/prix à Bad Homburg vor der Höhe ! Les clients en ont plus pour leur argent en comparaison avec d'autres établissements dans cette ville.</p>
						</div>
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Parking </br> Connexion Wi-Fi gratuite </br> Animaux domestiques admis </br> Chambres familiales </br> Salle de sport bien </br> Restaurant </br> Bar</p>
						</div>

...
<body>
	...
	<!-- BANNER -->
	<div class="section banner-page" data-background="images/dummy-img-900x600.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Single Work</div>
			</div>
		</div>
	</div>
<!--Formulaire Reserver-->
  ...
  <div class="container">
	...
	<!--Formulaire Reserver-->
	<div style="background-color: #e6ff99;padding-top: 32px;">
	<div class="container">
		<form action="chambre.php" method="POST">
		<div class="form-group">
	      	<label for="inputState">Pays</label>
	  ...
	  <div class="form-group">
	      ...
	      <select id="inputState" class="form-control" name="ville">
	        <option selected>IFRAN</option>
	      </select>
	  </div>
	 
	 	<div class="form-group">  
	      <label for="inputState">Hotel</label>
	      <select id="inputState" class="form-control" name="hotel">
	        <option selected>OHen HOTEL RAS EL MAA IFRANE</option>
	      </select>
	  </div>
	  	...
	  	<div class="form-group">
	      <label for="inputState">Chambres</label>
	      <select id="inputState" class="form-control" name="nbrchambre">
	        <option selected>1</option>
	        <option>2</option>
	        <option>3</option>
	        <option>4</option>
	  ...
	  <div class="form-group">  
	      <label for="inputState">Adultes</label>
	      <select id="inputState" class="form-control" name="nbradultes">
	        <option selected>1</option>
	        <option>2</option>
	        <option>3</option>
	  ...
	  <div class="form-group">
	      <label for="inputState">Enfants</label>
	      <select id="inputState" class="form-control" name="nbrenfants">
	        <option selected> 0</option>
	        <option>1</option>
	        <option>2</option>
	        <option>3</option>
  ...
  <div class="container">
    ...
    <div class="form-group"">
    	...
    	<label>Date d'épart : </label>
    	<input type="date" name="dateDep" id="date" class="form-control" style="display:inline">
    	<input type="submit" name="submit" class="btn btn-primary" style="margin-left: 20px;" value="Reserver">
    </div>
</div>
    </div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-4">
							<p class="uk18 text-black mb-1"><strong>Date</strong></p>
							<p>25th February, 2017</p>
							<p class="uk18 text-black mb-1"><strong>Skills</strong></p>
							<p>3D Max, Photoshop</p>
							<p class="uk18 text-black mb-1"><strong>Client</strong></p>
							<p>Videohive, Envato</p>	
							<p class="uk18 text-black mb-1"><strong>Project Link</strong></p>
							<p>http://rometheme.net</p>				
						</div>

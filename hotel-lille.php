	...
	<div class="section banner-page" data-background="images/cov22.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Lille</div>
			</div>
		</div>
	</div>
	...
	<div class="form-group">
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL ODALYS LILLE</option>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/paris5.jpg" alt="" class="img-fluid shadow" style="margin-top: 25px;">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/paris2.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/paris4.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>OHen Odalys se trouve à 20 minutes du centre-ville en transports en commun, à 30 minutes en métro des Champs-Élysées et à 20 minutes de route de La Défense. Les studios sont dotés d'une télévision à écran plat. Leur kitchenette est équipée d'un micro-ondes, d'un réfrigérateur et de plaques de cuisson. Un petit-déjeuner buffet est servi sur place. L'aéroport de LILLE-Orly est le plus proche, à 28 km de l'établissement.Ce quartier (17e arr.) est un choix idéal pour les voyageurs qui s'intéressent à ces thèmes : le shopping, les séjours romantiques et les monuments.

Cet établissement a également été bien noté pour son excellent rapport qualité/prix à Paris ! Les clients en ont plus pour leur argent en comparaison avec d'autres établissements dans cette ville.</p>
						</div>
						<div class="col-sm-12 col-md-4">
							<p class="uk18 text-black mb-1"><strong>Date d'ouverture :</strong></p>
							<p>11th Fevrier, 2018</p>
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Parking </br> Connexion Wi-Fi gratuite </br> Chambres familiales </br> Piscine </br> Chambres non-fumeurs </br> Piscine intérieure</p>
						</div>

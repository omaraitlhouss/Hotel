...
<body>
	...
	<!-- BANNER -->
	<div class="section banner-page" data-background="images/cov7.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Madrid</div>
			</div>
		</div>
	</div>
<!--Formulaire Reserver-->
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/mar5.jpg" alt="" class="img-fluid shadow" style="margin-top: 30px;">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/lc3.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/lc5.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Situated 300 metres from Royal Palace of Madrid Palacio Real in Madrid, Calle de Bailén offers accommodation with a kitchen. The property is less than 1 km from Mercado San Miguel.

The apartment comes with a cable flat-screen TV.

Plaza Mayor is a 13-minute walk from the apartment, while Puerta del Sol is 1.3 km from the property. The nearest airport is Adolfo Suarez Madrid-Barajas Airport, 26 km from Calle de Bailén.

Ce quartier (Centre de Madrid) est un choix idéal pour les voyageurs qui s'intéressent à ces thèmes : les tapas, l'architecture et les parcs.

C'est le quartier préféré des voyageurs visitant Madrid, selon les commentaires clients indépendants.</p>
						</div>
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Chambres familiales </br> Chauffage</p>
						</div>

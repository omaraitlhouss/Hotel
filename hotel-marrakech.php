...
<html lang="en">
  <head>
    ...
    <title>OREN - HOTEL MARRAKECH</title>
	...
	<div class="section banner-page" data-background="images/cov8.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Marrakech</div>
			</div>
		</div>
	</div>
<!--Formulaire Reserver-->
	...
	<div class="form-group">
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL CHEMSIYA MARRACKECH</option>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/77312549.jpg" alt="" class="img-fluid shadow">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/77312090.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/76649507.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Situé à 500 mètres de la place Jamaâ El Fna et de la mosquée Koutoubia, le Chemsiya Hotel propose un hébergement 4 étoiles. Il possède une piscine extérieure et un restaurant donnant sur la piscine et le jardin.

Toutes les chambres du Chems comportent un balcon privé avec vue et une télévision par satellite à écran LCD. Elles présentent une décoration simple et moderne et disposent d'une salle de bains privative.

Le restaurant est doté de grands piliers et sert un petit-déjeuner continental tous les matins. Par beau temps, vous pourrez dîner sur la terrasse de la piscine ou commander une collation au bar de la piscine.

Une connexion Wi-Fi est disponible gratuitement dans les chambres et les parties communes, et l'hôtel met également à votre disposition un parking privé sur place. L'aéroport de Marrakech-Menara est à seulement 5 km de l'établissement.

Ce quartier (Médina) est un choix idéal pour les voyageurs qui s'intéressent à ces thèmes : les marchés, les marchés en plein air et les souks.

C'est le quartier préféré des voyageurs visitant Marrakech, selon les commentaires clients indépendants.

Les couples apprécient particulièrement l'emplacement de cet établissement. Ils lui donnent la note de 8,8 pour un séjour à deux.</p>
						</div>
						...
						<div class="col-sm-12 col-md-8">
							...
							<p> Piscine </br> Connexion Wi-Fi gratuite </br> Spa et centre de bien-être </br> Navette aéroport </br> Parking gratuit </br> Chambres familiales </br> Bar</p>
						</div>

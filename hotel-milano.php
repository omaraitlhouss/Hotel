...
<body>
	...
	<!-- BANNER -->
	<div class="section banner-page" data-background="images/cov10.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Milano</div>
			</div>
		</div>
	</div>
<!--Formulaire Reserver-->
	...
	<div class="form-group">
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL Domina Milano Fiera MILANO</option>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/mi1.jpg" alt="" class="img-fluid shadow" style="">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/autres-atlantic_401285_pgbighd.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/188981756.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Le Domina Milano Fiera est situé à Novate Milanese, à respectivement 3 km et moins de 10 minutes en voiture des parcs des expositions Fiera Milano et Expo 2015. Doté d'une connexion Wi-Fi et d'un parking gratuits, l'hôtel propose un service de navette vers les parcs des expositions lors des principales manifestations.

Toutes les chambres du Domina Milano Fiera sont climatisées, modernes et spacieuses. Elles sont toutes pourvues de matelas orthopédiques, de parquet et d'une télévision à écran plat. Certaines chambres, qui sont situées au 4ème étage, offrent une vue sur le jardin.

Un copieux petit-déjeuner buffet est servi le matin. Vous pourrez savourer différentes spécialités de Lombardie et une cuisine internationale au sein du restaurant Expo. L'établissement possède également un bar, un salon d'affaires exécutif et une salle de sport.

L'hôtel se situe juste à côté du rond-point sur la route SP46, à proximité du supermarché Famila. Il est également situé à 5 minutes à pied de la gare de Novate Milanese, où vous pourrez prendre la ligne S3 afin de rejoindre la gare Cadorna et le centre-ville de Milan.
...
Cet établissement a également été bien noté pour son excellent rapport qualité/prix à Novate Milanese ! Les clients en ont plus pour leur argent en comparaison avec d'autres établissements dans cette ville.</p>
						</div>
						<div class="col-sm-12 col-md-4">
							<p class="uk18 text-black mb-1"><strong>Date d'ouverture :</strong></p>
							<p>18th October, 2017</p>

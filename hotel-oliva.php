...
<body>
	...
	<!-- BANNER -->
	<div class="section banner-page" data-background="images/cov4.jpg">
	...
	<div class="form-group">
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL CITADINES OLIVA </option>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/gre1.jpg" alt="" class="img-fluid shadow" style="">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/mar1.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/mar2.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>L'élégant Oliva Nova Beach & Golf Hotel propose une piscine de style lagon, un spa ainsi qu'un accès direct à la plage d'Oliva Nova. Cet établissement fait partie du parcours de golf d'Oliva Nova, conçu par Seve Ballesteros.

Chaque chambre élégante et spacieuse comprend un coin salon, une télévision à écran plat et une connexion Wi-Fi gratuite. Elles bénéficient également d'une terrasse couverte donnant sur le complexe, les dunes de sable voisines ou les montagnes Montgó.

Vous pourrez déguster des plats de riz typiquement valenciens au restaurant El Olivo sur place. Vous apprécierez aussi le restaurant avec terrasse bordant la piscine ainsi que le pub irlandais et le bar de plage. Les installations de spa sont disponibles moyennant des frais supplémentaires.

Situé entre Gandie et Dénia, l'Hotel Oliva Nova se trouve à 45 minutes de route de Valence. Les villes de Valence et Alicante sont facilement accessibles par les autoroutes N-332 et AP-7.
...
Les couples apprécient particulièrement l'emplacement de cet établissement. Ils lui donnent la note de 8,8 pour un séjour à deux.</p>
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Piscine </br> Parking gratuit </br> Connexion Wi-Fi gratuite </br> Front de mer </br> Spa et centre de bien-être </br> Piscine extérieure </br> Bar</p>
						</div>

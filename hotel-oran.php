	...
	<div class="section banner-page" data-background="images/cov7.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Oran</div>
			</div>
		</div>
	</div>
<!--Formulaire Reserver-->
	...
	<div class="form-group">
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL BACHA Oran</option>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/oran2.jpg" alt="" class="img-fluid shadow" style="margin-top: 50px;">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/oran4.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/oran1.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Situé à Oran, Le Méridien se trouve sur la côte méditerranéenne. Il dispose d'une piscine extérieure, d'un spa et d'un centre de remise en forme offrant une vue sur la mer. Différents restaurants seront également à votre disposition.

Chaque chambre climatisée affiche une décoration moderne et dispose d'un coin salon ainsi que d'un balcon offrant une vue sur le jardin ou la mer. Elles comprennent une télévision à écran plat, un minibar, du matériel de repassage, ainsi qu'une salle de bains privative dotée d'une baignoire et d'articles de toilette gratuits.

Vous pourrez déguster des spécialités italiennes au Favola ou des plats gastronomiques au Latest Recipe. Vous pourrez également vous détendre au Latitude 35, un bar doté d'une terrasse qui donne sur la mer. Le Méridien propose également des service de concierge et de change, ainsi qu'un centre d'affaires et de conférences.

L'aéroport international d'Oran est accessible en 15 minutes en voiture. Le musée Ahmed Zabana se trouve à 2 km de l'hôtel et la Promenade de Ibn Badis à 3 km. Un parking privé gratuit sera à votre disposition sur place.

Les couples apprécient particulièrement l'emplacement de cet établissement. Ils lui donnent la note de 8,1 pour un séjour à deux</p>
						</div>
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Connexion Wi-Fi gratuite </br> Parking gratuit </br> Navette aéroport </br> Restaurant </br> Piscine </br> Spa et centre de bien-être </br> Bar</p>
						</div>

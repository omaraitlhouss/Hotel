	...
	<div class="section banner-page" data-background="images/cov8.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">Hotel Rabat</div>
			</div>
		</div>
	</div>
<!--Formulaire Reserver-->
	...
	<div class="form-group">
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL RIAD RABAT</option>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/76530605.jpg" alt="" class="img-fluid shadow" style="margin-top: 50px;">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/restaurant-atlantic_401282_pgbighd.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/restaurant-atlantic_402062_pgbighd.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="content-wrap">
					<div class="row">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p>Situé à Rabat, le Riad propose un service chaleureux et agréable dans un cadre authentique. Il constitue un pied-à-terre idéal pour découvrir la région.

Les chambres, personnalisées, offrent un charme unique. Elles sont décorées dans un style très oriental, confortable ou contemporain. Vous pourrez profiter du décor unique, des fleurs, des fruits, des livres et de la musique à votre disposition.

La salle à manger sert des plats traditionnels marocains et vous pourrez écouter de la musique locale près de la cheminée du salon. Détendez-vous sur une des terrasses ouvertes du riad.

Le Riad Dar Mayssane présente une atmosphère chaleureuse et vivante. Vous pouvez profiter des nombreux soins de beauté disponibles tels que les gommages exfoliants, les manucures, les massages et les bains de pétales de roses.

Ce quartier (Médina) est un choix idéal pour les voyageurs qui s'intéressent à ces thèmes : les marchés, l'exploration de la vieille ville et les visites.

Cet établissement a également été bien noté pour son excellent emplacement à Rabat ! Les clients en sont plus satisfaits en comparaison avec d'autres établissements dans cette ville.
...
Cet établissement a également été bien noté pour son excellent rapport qualité/prix à Rabat ! Les clients en ont plus pour leur argent en comparaison avec d'autres établissements dans cette ville.
...
Nous parlons votre langue !</p>
						...
						<div class="col-sm-12 col-md-8">
							<h3 class="text-primary">Ses points forts </h3>
							<p>Parking </br> Connexion Wi-Fi gratuite </br> Chambres familiales </br> Restaurant </br> Chambres non-fumeurs </br> Réception ouverte 24h/24 </br> Bar</p>
						</div>

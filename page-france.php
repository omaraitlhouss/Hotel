...
include "admin/includes/conx.php";
  $prepare=$pdo->query("select * from hotel where Pays='France'");
...
<body>
    ...
    <!-- BANNER -->
	<div class="section banner-full bgi-cover-center" data-background="images/france_paris_city_eiffel_tower_sky_clouds_sunset_59583_1920x1080.jpg">
		<div class="container h-100 d-flex align-items-center">
			
        	<div class="wrap-caption text-white">
                <h1 class="caption-heading">Séjournez A France<br>with OREN.</h1>
...
<!-- PORTFOLIO -->
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-12">
					...
					<p class="subheading text-center">EUROPE OCCIDENTALE</p>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-12 col-md-12">
					<div class="grid mt-3">
						...
						<!-- item 1 -->
						<div class="grid-item">
							<a href="images/f1.jpg" title="Portfolio 1"><img src="images/f1.jpg" alt=""></a>
						</div>
						<!-- item 2 -->
						<div class="grid-item">
							<a href="images/f7.jpg" title="Portfolio 2"><img src="images/f7.jpg" alt=""></a>
						</div>
						<!-- item 3 -->
						<div class="grid-item">
							<a href="images/f2.jpg" title="Portfolio 3"><img src="images/f2.jpg" alt=""></a>
						</div>
						<!-- item 4 -->
						<div class="grid-item">
							<a href="images/f8.jpg" title="Portfolio 4"><img src="images/f8.jpg" alt=""></a>
						</div>
						<!-- item 5 -->
						<div class="grid-item">
							<a href="images/f9.jpg" title="Portfolio 5"><img src="images/f9.jpg" alt=""></a>
						</div>
						<!-- item 6 -->
						<div class="grid-item">
							<a href="images/f3.jpg" title="Portfolio 6"><img src="images/f3.jpg" alt=""></a>
						</div>
						<!-- item 7 -->
						<div class="grid-item">
							<a href="images/f4.jpg" title="Portfolio 7"><img src="images/f4.jpg" alt=""></a>
						</div>
						<!-- item 8 -->
						<div class="grid-item">
							<a href="images/f12.jpg" title="Portfolio 8"><img src="images/f12.jpg" alt=""></a>
						</div>
						<!-- item 9 -->
						<div class="grid-item">
							<a href="images/f5.jpg" title="Portfolio 9"><img src="images/f5.jpg" alt=""></a>
						</div>
						<!-- item 10 -->
						<div class="grid-item">
							<a href="images/f11.jpg" title="Portfolio 10"><img src="images/f11.jpg" alt=""></a>
						</div>
						<!-- item 11 -->
						<div class="grid-item">
							<a href="images/f10.jpg" title="Portfolio 11"><img src="images/f10.jpg" alt=""></a>
						</div>
						<!-- item 12 -->
						<div class="grid-item">
							<a href="images/f6.jpg" title="Portfolio 12"><img src="images/f6.jpg" alt=""></a>
						</div>
					</div>
	...
	<script type="text/javascript" src="page-france.js">

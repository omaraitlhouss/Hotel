...
include "admin/includes/conx.php";
  $prepare=$pdo->query("select * from hotel where Pays='Germany'");
...
<body>
    ...
    <!-- BANNER -->
	<div class="section banner-full bgi-cover-center" data-background="images/germany_frankfurt_am_main_metropolis_panorama_architecture_tall_buildings_houses_streets_traffic_blue_sky_warm_sunny_day_clouds_horizon_59445_1920x1080.jpg">
		<div class="container h-100 d-flex align-items-center">
			
        	<div class="wrap-caption text-white">
                <h1 class="caption-heading">Séjournez A Germany<br>with OREN.</h1>
...
<!--Formulaire Reserver-->
	...
	<div class="form-group">
	      ...
	      <select id="inputState" class="form-control" name="ville" onclick="m(ville.value)" style="width: 26%;"> 
	       <option selected>MUNICH</option>
	        <option >LEBBIN</option>
	        <option >HOMBURG</option>
	        <option >HELIGENDAMM</option>
	        <option >GAGER</option>
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL Vier Jahreszeiten Kempinski München</option>
...
<!-- PORTFOLIO -->
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-12">
					...
					<p class="subheading text-center">EUROPE CENTRAL OCCIDENTALE</p>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-12 col-md-12">
					<div class="grid mt-3">
						...
						<!-- item 1 -->
						<div class="grid-item">
							<a href="images/g1.jpg" title="Portfolio 1"><img src="images/g1.jpg" alt=""></a>
						</div>
						<!-- item 2 -->
						<div class="grid-item">
							<a href="images/g7.jpg" title="Portfolio 2"><img src="images/g7.jpg" alt=""></a>
						</div>
						<!-- item 3 -->
						<div class="grid-item">
							<a href="images/g2.PNG" title="Portfolio 3"><img src="images/g2.PNG" alt=""></a>
						</div>
						<!-- item 4 -->
						<div class="grid-item">
							<a href="images/g8.jpg" title="Portfolio 4"><img src="images/g8.jpg" alt=""></a>
						</div>
						<!-- item 5 -->
						<div class="grid-item">
							<a href="images/g9.jpg" title="Portfolio 5"><img src="images/g9.jpg" alt=""></a>
						</div>
						<!-- item 6 -->
						<div class="grid-item">
							<a href="images/g3.jpg" title="Portfolio 6"><img src="images/g3.jpg" alt=""></a>
						</div>
						<!-- item 7 -->
						<div class="grid-item">
							<a href="images/g4.jpg" title="Portfolio 7"><img src="images/g4.jpg" alt=""></a>
						</div>
						<!-- item 8 -->
						<div class="grid-item">
							<a href="images/g12.jpg" title="Portfolio 8"><img src="images/g12.jpg" alt=""></a>
						</div>
						<!-- item 9 -->
						<div class="grid-item">
							<a href="images/g5.jpg" title="Portfolio 9"><img src="images/g5.jpg" alt=""></a>
						</div>
						<!-- item 10 -->
						<div class="grid-item">
							<a href="images/g11.jpg" title="Portfolio 10"><img src="images/g11.jpg" alt=""></a>
						</div>
						<!-- item 11 -->
						<div class="grid-item">
							<a href="images/g10.jpg" title="Portfolio 11"><img src="images/g10.jpg" alt=""></a>
						</div>
						<!-- item 12 -->
						<div class="grid-item">
							<a href="images/g6.jpg" title="Portfolio 12"><img src="images/g6.jpg" alt=""></a>
						</div>
					</div>
	...
	<script type="text/javascript" src="page-germany.js">

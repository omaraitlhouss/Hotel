...
include "admin/includes/conx.php";
  $prepare=$pdo->query("select * from hotel where Pays='Italy'");
...
<body>
    ...
    <!-- BANNER -->
	<div class="section banner-full bgi-cover-center" data-background="images/florence_italy_buildings_panorama_hdr_69304_1920x1080.jpg">
		<div class="container h-100 d-flex align-items-center">
			
        	<div class="wrap-caption text-white">
                <h1 class="caption-heading">Séjournez A Italy<br>with OREN.</h1>
...
<!--Formulaire Reserver-->
	...
	<div class="form-group">
	      ...
	      <select id="inputState" class="form-control" name="ville" onclick="m(ville.value)" style="width: 26%;"> 
	        ...
	        <option >CALVAGESE</option>
	        <option selected>MILANO</option>
	        <option >GIUBILIANA</option>
...
<!-- PORTFOLIO -->
			...
			<div class="row">
				<div class="col-sm-12 col-md-12">
					<div class="grid mt-3">
						...
						<!-- item 1 -->
						<div class="grid-item">
							<a href="images/i1.jpg" title="Portfolio 1"><img src="images/i1.jpg" alt=""></a>
						</div>
						<!-- item 2 -->
						<div class="grid-item">
							<a href="images/i7.jpg" title="Portfolio 2"><img src="images/i7.jpg" alt=""></a>
						</div>
						<!-- item 3 -->
						<div class="grid-item">
							<a href="images/i2.jpg" title="Portfolio 3"><img src="images/i2.jpg" alt=""></a>
						</div>
						<!-- item 4 -->
						<div class="grid-item">
							<a href="images/i8.jpg" title="Portfolio 4"><img src="images/i8.jpg" alt=""></a>
						</div>
						<!-- item 5 -->
						<div class="grid-item">
							<a href="images/i9.jpg" title="Portfolio 5"><img src="images/i9.jpg" alt=""></a>
						</div>
						<!-- item 6 -->
						<div class="grid-item">
							<a href="images/i3.jpg" title="Portfolio 6"><img src="images/i3.jpg" alt=""></a>
						</div>
						<!-- item 7 -->
						<div class="grid-item">
							<a href="images/i4.jpg" title="Portfolio 7"><img src="images/i4.jpg" alt=""></a>
						</div>
						<!-- item 8 -->
						<div class="grid-item">
							<a href="images/i12.jpg" title="Portfolio 8"><img src="images/i12.jpg" alt=""></a>
						</div>
						<!-- item 9 -->
						<div class="grid-item">
							<a href="images/i5.png" title="Portfolio 9"><img src="images/i5.png" alt=""></a>
						</div>
						<!-- item 10 -->
						<div class="grid-item">
							<a href="images/i11.jpg" title="Portfolio 10"><img src="images/i11.jpg" alt=""></a>
						</div>
						<!-- item 11 -->
						<div class="grid-item">
							<a href="images/i10.jpg" title="Portfolio 11"><img src="images/i10.jpg" alt=""></a>
						</div>
						<!-- item 12 -->
						<div class="grid-item">
							<a href="images/i6.jpg" title="Portfolio 12"><img src="images/i6.jpg" alt=""></a>
						</div>
					</div>
	...
	<script type="text/javascript" src="page-italy.js">

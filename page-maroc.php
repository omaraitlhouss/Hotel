...
include "admin/includes/conx.php";
  $prepare=$pdo->query("select * from hotel where Pays='Maroc'");
...
<body>
    ...
    <!-- BANNER -->
	<div class="section banner-full bgi-cover-center" data-background="images/morocco-chefchaouen-1440x561.jpg">
		<div class="container h-100 d-flex align-items-center">
			
        	<div class="wrap-caption text-white">
                <h1 class="caption-heading">Séjournez A Maroc<br>with OREN.</h1>
...
<!-- PORTFOLIO -->
			...
			<div class="row">
				<div class="col-sm-12 col-md-12">
					<div class="grid mt-3">
						...
						<!-- item 1 -->
						<div class="grid-item">
							<a href="images/m1.jpg" title="Portfolio 1"><img src="images/m1.jpg" alt=""></a>
						</div>
						<!-- item 2 -->
						<div class="grid-item">
							<a href="images/m7.jpg" title="Portfolio 2"><img src="images/m7.jpg" alt=""></a>
						</div>
						<!-- item 3 -->
						<div class="grid-item">
							<a href="images/m2.jpg" title="Portfolio 3"><img src="images/m2.jpg" alt=""></a>
						</div>
						<!-- item 4 -->
						<div class="grid-item">
							<a href="images/m8.jpg" title="Portfolio 4"><img src="images/m8.jpg" alt=""></a>
						</div>
						<!-- item 5 -->
						<div class="grid-item">
							<a href="images/m9.jpg" title="Portfolio 5"><img src="images/m9.jpg" alt=""></a>
						</div>
						<!-- item 6 -->
						<div class="grid-item">
							<a href="images/m3.jpg" title="Portfolio 6"><img src="images/m3.jpg" alt=""></a>
						</div>
						<!-- item 7 -->
						<div class="grid-item">
							<a href="images/m4.jpg" title="Portfolio 7"><img src="images/m4.jpg" alt=""></a>
						</div>
						<!-- item 8 -->
						<div class="grid-item">
							<a href="images/m12.jpg" title="Portfolio 8"><img src="images/m12.jpg" alt=""></a>
						</div>
						<!-- item 9 -->
						<div class="grid-item">
							<a href="images/m5.jpg" title="Portfolio 9"><img src="images/m5.jpg" alt=""></a>
						</div>
						<!-- item 10 -->
						<div class="grid-item">
							<a href="images/m11.jpg" title="Portfolio 10"><img src="images/m11.jpg" alt=""></a>
						</div>
						<!-- item 11 -->
						<div class="grid-item">
							<a href="images/m10.jpg" title="Portfolio 11"><img src="images/m10.jpg" alt=""></a>
						</div>
						<!-- item 12 -->
						<div class="grid-item">
							<a href="images/m6.jpg" title="Portfolio 12"><img src="images/m6.jpg" alt=""></a>
						</div>
					</div>
	...
	<script type="text/javascript" src="page-maroc.js">

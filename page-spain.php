...
include "admin/includes/conx.php";
  $prepare=$pdo->query("select * from hotel where Pays='Spain'");
...
<body>
    ...
    <!-- BANNER -->
	<div class="section banner-full bgi-cover-center" data-background="images/hero-spain-to-provence.jpg">
		<div class="container h-100 d-flex align-items-center">
			
        	<div class="wrap-caption text-white">
                <h1 class="caption-heading">Séjournez A Spain<br>with OREN.</h1>
...
<!--Formulaire Reserver-->
	...
	<div class="form-group">
	      ...
	      <select id="inputState" class="form-control" name="ville" onclick="b(ville.value)" style="width: 26%;"> 
	       <option selected>MADRID</option>
	        <option >OLIVA</option>
	        <option >LOSCRISTIANOS</option>
	        <option >BARCELONE</option>
	        <option >MARBILLA</option>
	 ...
	 <div class="form-group" style="margin-left: 15px;">
	      ...
	      <select id="inputState" class="form-control" name="hotel" style="width: 35%;">
	        <option selected>OHen HOTEL MADRID</option>
...
<!-- PORTFOLIO -->
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-12">
					...
					<p class="subheading text-center">SUD D'EUROPE</p>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-12 col-md-12">
					<div class="grid mt-3">
						...
						<!-- item 1 -->
						<div class="grid-item">
							<a href="images/s1.jpg" title="Portfolio 1"><img src="images/s1.jpg" alt=""></a>
						</div>
						<!-- item 2 -->
						<div class="grid-item">
							<a href="images/s7.jpg" title="Portfolio 2"><img src="images/s7.jpg" alt=""></a>
						</div>
						<!-- item 3 -->
						<div class="grid-item">
							<a href="images/s2.jpg" title="Portfolio 3"><img src="images/s2.jpg" alt=""></a>
						</div>
						<!-- item 4 -->
						<div class="grid-item">
							<a href="images/s8.jpg" title="Portfolio 4"><img src="images/s8.jpg" alt=""></a>
						</div>
						<!-- item 5 -->
						<div class="grid-item">
							<a href="images/s9.jpg" title="Portfolio 5"><img src="images/s9.jpg" alt=""></a>
						</div>
						<!-- item 6 -->
						<div class="grid-item">
							<a href="images/s3.jpg" title="Portfolio 6"><img src="images/s3.jpg" alt=""></a>
						</div>
						<!-- item 7 -->
						<div class="grid-item">
							<a href="images/s4.jpg" title="Portfolio 7"><img src="images/s4.jpg" alt=""></a>
						</div>
						<!-- item 8 -->
						<div class="grid-item">
							<a href="images/s12.jpg" title="Portfolio 8"><img src="images/s12.jpg" alt=""></a>
						</div>
						<!-- item 9 -->
						<div class="grid-item">
							<a href="images/s5.jpg" title="Portfolio 9"><img src="images/s5.jpg" alt=""></a>
						</div>
						<!-- item 10 -->
						<div class="grid-item">
							<a href="images/s11.jpg" title="Portfolio 10"><img src="images/s11.jpg" alt=""></a>
						</div>
						<!-- item 11 -->
						<div class="grid-item">
							<a href="images/s10.jpg" title="Portfolio 11"><img src="images/s10.jpg" alt=""></a>
						</div>
						<!-- item 12 -->
						<div class="grid-item">
							<a href="images/s6.jpg" title="Portfolio 12"><img src="images/s6.jpg" alt=""></a>
						</div>
					</div>
	...
	<script src="js/script.js"></script>
	<script type="text/javascript" src="page-spain.js">

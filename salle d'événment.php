<?php 
 include "admin/includes/conx.php";
  $prepare=$pdo->query("select * from services where Nom_ser='salle d'evenement");
...
<html lang="en">
  <head>
    ...
    <title>OREN - Service Salle d'événment</title>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/sal1.jpg" alt="" class="img-fluid shadow" style="">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/sal2.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/Salle_de_fete.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>

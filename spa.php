<?php 
 include "admin/includes/conx.php";
  $prepare=$pdo->query("select * from services where Nom_ser='spa'");
...
<!--Header-->
	...
	<!-- BANNER -->
	<div class="section banner-page" data-background="images/spa3.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-3">
				<div class="title-page">SPA</div>
			</div>
		</div>
	</div>
			...
			<div class="container">						
				...
				<div class="row">
					<div class="col-sm-8 col-md-8">
						<img src="images/spa2.jpg" alt="" class="img-fluid shadow" style="">
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="row">
							<div class="col-sm-12 col-md-12 mb-4">
								<img src="images/spa1.jpg" alt="" class="img-fluid shadow">
							</div>
							<div class="col-sm-12 col-md-12">
								<img src="images/spa.jpg" alt="" class="img-fluid shadow">
							</div>
						</div>
					</div>
				</div>
